...
class MotionTest {
  ...
  @Test
  @DisplayName(
      "Setters with Null Edge Case: Converts null arrays to empty arrays safely via constructor")
  ...
  void testParameterizedConstructor() {
    ...
    Motion customMotion = new Motion(testCurves, testDurations, null, null, null, true);
