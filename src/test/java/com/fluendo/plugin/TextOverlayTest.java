...
class TextOverlayTest {
  ...
  void testUnknownPropertyHandling() {
    assertFalse(
        textOverlay.setProperty("unknown_prop", "value"),
        "Setting unknown property should return false");
    assertNull(
        textOverlay.getProperty("unknown_prop"), "Getting unknown property should return null");
  }
  ...
  void testOverlayWithDirectImageBuffer() {
    ...
    assertDoesNotThrow(
        () -> textOverlay.overlay(buffer), "Overlay processing with Image buffer should not throw");
  }
  ...
  void testOverlayWithImageProducerBuffer() {
    ...
    assertDoesNotThrow(
        ...
        "Overlay processing with ImageProducer should not throw");
  }
  ...
  void testOverlayWithUnknownBufferType() {
    ...
    assertDoesNotThrow(
        () -> textOverlay.overlay(buffer),
        "Unknown buffer objects should be safely logged/skipped");
  }
