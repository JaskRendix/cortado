...
public class HTTPSrc extends Element {
    ...
    private final Pad srcpad = new Pad(Pad.SRC, "src") {
        ...
        protected void taskFunc() {
            ...
            if (contentLength > 0 && offset - offsetLastMessage > contentLength / 100) {
                postMessage(Message.newBytePosition(this, offset));
                offsetLastMessage = offset;
            }
            ...
            if (srcpad.getCaps() == null) {
                ...
                if (typeMime != null) {
                    if (!typeMime.equals(mime)) {
                        Debug.log(Debug.WARNING, "server contentType: " + mime + " disagrees with our typeFind: " + typeMime);
                    }
    ...
    public synchronized boolean setProperty(String name, java.lang.Object value) {
        ...
        } else if (Objects.equals(name, "documentBase")) {
            documentBase = (URL) value;
        } else if (Objects.equals(name, "userId")) {
            userId = (value == null) ? null : String.valueOf(value);
        } else if (Objects.equals(name, "userAgent")) {
